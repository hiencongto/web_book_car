...
<!-- Mirrored from themes.pixelstrap.com/voxo/email-template/reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Nov 2024 16:48:21 GMT -->
<head>
                        ...
                        <ul>
                            ...
                            <li style="display: block;text-decoration: unset" class="reset-contain">
                                ...
                                <h4 class="market">That's okay,it happens! Click on the button below to reset
                                    your password</h4>
                                <button><a href="{{route('form_new_pass', ['email' => $details['email'], 'resetToken' => $details['resetToken']])}}"
                                           style="color: white">Reset Password</a></button>
                            </li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    <div class="title title-2 text-center">
                        <h6>your email :- <a href="#"
                                             style="font-weight: 600; text-decoration: underline;">{{$details['email']}}</a>
                        </h6>
...
<!-- Mirrored from themes.pixelstrap.com/voxo/email-template/reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Nov 2024 16:48:32 GMT -->
</html>
